(function () {
    ...
    try {
        ...
        var widthPlace = doc.activeLayer.bounds[2] - doc.activeLayer.bounds[0];
        var hightPlace = doc.activeLayer.bounds[3] - doc.activeLayer.bounds[1];
        resizeImage(widthPlace/2,hightPlace/2);
        actionMenu("freeTransform");
        doc.activeLayer.name = "Light";
